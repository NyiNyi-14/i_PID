...
iPID = iPID_controller(Kp = Kp_pen, Ki = Ki_pen, Kd = Kd_pen)
closed_loop = Closed_loop(pendulum, iPID)
...
# %%
zeta = 0.0107 # look at MATLAB Root Locus, s = -0.0481 + 4.49j
omega_n = 4.49 # look at MATLAB Root Locus

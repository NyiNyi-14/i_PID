...
plt.plot(t, step_ref,'r', label = r'$ x_{\mathrm{ref}} $',linewidth=2)
...
plt.figure(figsize=(8, 6))
plt.plot(t, exp_ref,'r', label = r'$ x_{\mathrm{ref}} $',linewidth=2)
...
plt.figure(figsize=(8, 6))
plt.plot(t, normal_is,'c--', label = r'$ x_{\mathrm{normal\ shaped\ ref}} $',linewidth=2)
plt.plot(t, PID_normal_is[:,0],'c-', label=r'$ x_{\mathrm{response\ to\ normal\ shaped}} $', linewidth=2)
plt.plot(t, robust_is,'b--', label = r'$ x_{\mathrm{robust\ shaped\ ref}} $',linewidth=2)
